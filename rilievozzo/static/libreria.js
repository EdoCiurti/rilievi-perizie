 ...
 * @param {boolean} isFormData Flag to indicate if the params are FormData
 * @returns
 */
async function inviaRichiesta(method, url = '', params = {}, isFormData = false, headers = {}) {
  ...
  // Aggiungi il token JWT all'header Authorization
  ...
  if (method == 'GET') {
    ...
    if (params instanceof FormData || isFormData) {
